...
//        }
//
//        val myButton = findViewById<Button>(R.id.buttonn)
//        myButton.setOnClickListener {
//            val intent = Intent(this, ReadyToDonate::class.java)
...
//
//        var isAllFieldsFilled = true // flag to check if all fields are filled
//
//        if (Name.isEmpty()) {
//            name.error = "Please enter a name"
//            isAllFieldsFilled = false
//            Log.d("Itemm", "Name field is empty")
//        }
//
//        if (Number.isEmpty()) {
...
//
//        if (Typee.isEmpty()) {
//            Toast.makeText(this, "Please select a donation type", Toast.LENGTH_LONG).show()
//            isAllFieldsFilled = false
//        }
//        if (Email.isEmpty()) {
...
//            val donation = DonationModel(donationId, Name, Number, Typee, Email, Description)
//
